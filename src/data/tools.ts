...
export const tools: ToolData[] = [
  ...
  // NEW NUMEROLOGY TOOLS
  {
    ...
    shortDescription: "Find the perfect numerologically aligned name for your baby.",
    metaTitle: "Baby Name Numerology Calculator – Best Name for Your Child (Free)",
    metaDescription: "Check baby name numerology to find a lucky, meaningful name. Analyze any name's vibration using Pythagorean numerology. Free & instant.",
    category: "numerology",
    icon: "👶",
    popular: true,
    ...
    faqs: [
      ...
      { question: "Should I check first name or full name?", answer: "Check both — first name for daily energy, full name for overall life influence." },
      { question: "What's the best number for a baby name?", answer: "There's no universally 'best' number. Ideally, it should complement the baby's life path number." },
      { question: "Can I check multiple names?", answer: "Yes! Check as many variations as you like to find the best fit." },
  ...
  },
  {
    ...
    shortDescription: "Check if your business name is numerologically powerful.",
    metaTitle: "Business Name Numerology Calculator – Lucky Business Name (Free)",
    ...
    faqs: [
      ...
      { question: "What number is best for business?", answer: "Numbers 1, 5, and 8 are often considered powerful for business success." },
      { question: "Should I include 'Pvt Ltd' or 'LLC'?", answer: "Typically analyze just the brand name, not legal suffixes." },
      { question: "Can I rename my business based on this?", answer: "Many entrepreneurs adjust spellings or add words to shift their brand's vibration." },
  ...
  },
  {
    ...
    shortDescription: "Generate name variations that match your desired lucky number.",
    metaTitle: "Lucky Name Generator – Find a Name Matching Your Lucky Number (Free)",
    ...
    faqs: [
      ...
      { question: "Are the suggestions real names?", answer: "They are spelling variations — some may be real names, others creative modifications. Use them as inspiration." },
      { question: "Can I use this for business names?", answer: "Absolutely! It works for any text — personal names, brands, or business names." },
      { question: "What if no suggestions appear?", answer: "Try a different target number or a shorter name for more possibilities." },
  ...
  },
  {
    ...
    shortDescription: "Check numerological compatibility between two people.",
    metaTitle: "Marriage Compatibility Calculator – Numerology Love Match (Free)",
    metaDescription: "Check marriage compatibility using life path numbers. Discover how well you and your partner match numerologically. Free love compatibility tool.",
    category: "numerology",
    icon: "💕",
    popular: true,
    ...
    faqs: [
      ...
      { question: "Is numerology compatibility accurate?", answer: "It's a fun and insightful tool, but relationships depend on many factors beyond numbers." },
      { question: "What's the best life path match?", answer: "Some popular compatible pairs include 1&5, 2&6, and 3&9, but any combination can work with effort." },
      { question: "Can I check compatibility with friends?", answer: "Yes! Life path compatibility applies to any relationship, not just romantic ones." },
  ...
  // NEW HEALTH TOOLS
  {
    ...
    metaTitle: "Body Fat Calculator – Free Body Fat Percentage Estimator",
    ...
    faqs: [
      ...
      { question: "Where do I measure my waist?", answer: "Measure at the narrowest point, typically at the navel level for men, and the widest point for hip measurement." },
      { question: "What's a healthy body fat percentage?", answer: "For men: 10-20%. For women: 18-28%. Athletes may be lower." },
      { question: "How often should I measure?", answer: "Every 2-4 weeks is sufficient to track progress." },
  ...
  },
  {
    ...
    shortDescription: "Estimate your baby's due date from your last period.",
    metaTitle: "Pregnancy Due Date Calculator – When Is My Baby Due? (Free)",
    metaDescription: "Calculate your pregnancy due date based on your last menstrual period. Find your trimester and weeks pregnant. Free instant due date calculator.",
    category: "health",
    icon: "🤰",
    popular: true,
    ...
    faqs: [
      ...
      { question: "What if I don't know my LMP?", answer: "An ultrasound in the first trimester can provide a more accurate estimate. Consult your doctor." },
      { question: "Does cycle length matter?", answer: "Yes — longer or shorter cycles shift ovulation timing, which affects the due date." },
      { question: "When should I see a doctor?", answer: "Schedule your first prenatal visit as soon as you confirm pregnancy, ideally by 8 weeks." },
  ...
  },
  {
    ...
    shortDescription: "Find your most fertile days and ovulation date.",
    metaTitle: "Ovulation Calculator – Find Your Fertile Window (Free)",
    ...
    faqs: [
      ...
      { question: "How long is the fertile window?", answer: "The fertile window is about 6 days — 5 days before ovulation and the day of ovulation." },
      { question: "Can I get pregnant outside the fertile window?", answer: "It's very unlikely but not impossible, as sperm can survive up to 5 days." },
      { question: "What if my cycles are irregular?", answer: "This calculator works best for regular cycles. For irregular cycles, consider ovulation test kits." },
