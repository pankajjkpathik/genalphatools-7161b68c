    ...
    <div className="container py-10">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
        <div className="col-span-2">
          ...
          <p className="text-sm text-muted-foreground mb-3">Free online numerology &amp; health calculators built on trusted formulas. Instant results, no sign-up, your data never leaves your browser.</p>
          <a href="mailto:contact@genalphatools.com" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
            <Mail size={14} /> contact@genalphatools.com
          </a>
          <div className="flex items-center gap-3 mt-3">
            <a href="https://twitter.com/GenAlphaTools" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="text-muted-foreground hover:text-foreground transition-colors"><Twitter size={16} /></a>
            <a href="https://facebook.com/GenAlphaTools" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-muted-foreground hover:text-foreground transition-colors"><Facebook size={16} /></a>
            <a href="https://instagram.com/GenAlphaTools" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-foreground transition-colors"><Instagram size={16} /></a>
          </div>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/numerology-tools" className="hover:text-foreground transition-colors">All Numerology Tools</Link></li>
          </ul>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/health-calculators" className="hover:text-foreground transition-colors">All Health Calculators</Link></li>
          </ul>
        </div>
        <div>
