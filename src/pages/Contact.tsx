...
const Contact = () => (
  <>
    <SEOHead title="Contact Us | AnkDarppan Tools" description="Get in touch with the AnkDarppan Tools team for feedback, queries, or collaboration." />
    <SiteHeader />
    <main className="container py-8 max-w-3xl">
      ...
      <div className="text-muted-foreground space-y-4 text-sm">
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          <p><strong className="text-foreground">Email:</strong> contact@ankdarppan.com</p>
