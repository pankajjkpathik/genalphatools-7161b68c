...
const About = () => (
  <>
    <SEOHead title="About Us | AnkDarppan Tools" description="Learn about AnkDarppan Tools – your trusted source for free online numerology and health calculators." />
    <SiteHeader />
    <main className="container py-8 max-w-3xl">
      <Breadcrumbs items={[{ label: "About Us" }]} />
      <h1 className="font-heading font-bold text-2xl md:text-3xl mb-4">About AnkDarppan Tools</h1>
      <div className="prose prose-sm text-muted-foreground space-y-4">
        <p>AnkDarppan Tools is your one-stop destination for free, accurate online calculators. We specialize in two domains: <strong>Numerology</strong> and <strong>Health & Wellness</strong>.</p>
